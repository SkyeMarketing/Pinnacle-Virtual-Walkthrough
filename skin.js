...
// Pano2VR 6.1.0/17841
// Filename: Pinnacle - Unit B_skin.ggsk
// Generated 2024-07-09T15:32:02
...
function pano2vrSkin(player,base) {
	...
	player.addVariable('vis_instructions', 2, false);
	var me=this;
	var skin=this;
	var flag=false;
	var nodeMarker=[];
	...
	this.addSkin=function() {
		...
		el=me._back_no_visible=document.createElement('div');
		el.ggId="back no visible";
		el.ggDx=0;
		el.ggDy=0;
		...
		me._back_no_visible.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._back_no_visible.ggUpdatePosition=function (useTransition) {
		...
		me.divSkin.appendChild(me._back_no_visible);
		...
		me._disclaimer.logicBlock_scaling = function() {
			...
			if (me._disclaimer.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._disclaimer.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._disclaimer.style[domTransition]='' + cssPrefix + 'transform 0s';
				if (me._disclaimer.ggCurrentLogicStateScaling == 0) {
					me._disclaimer.ggParameter.sx = 0.7;
					me._disclaimer.ggParameter.sy = 0.7;
					me._disclaimer.style[domTransform]=parameterToTransform(me._disclaimer.ggParameter);
				}
				else {
					me._disclaimer.ggParameter.sx = 1;
					me._disclaimer.ggParameter.sy = 1;
					me._disclaimer.style[domTransform]=parameterToTransform(me._disclaimer.ggParameter);
				}
			}
		}
		...
		el=me._disclaimer_customized=document.createElement('div');
		els=me._disclaimer_customized__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="Disclaimer customized";
		el.ggDx=0;
		el.ggDy=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=false;
		...
		els.innerHTML="Todas las im\xe1genes son una representaci\xf3n art\xedstica y el promotor se reserva el derecho a modificarlas.";
		el.appendChild(els);
		me._disclaimer_customized.ggIsActive=function() {
		...
		me._disclaimer_customized.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
			...
			this.ggTextDiv.style.left=((841-this.ggTextDiv.offsetWidth)/2) + 'px';
		}
		me._disclaimer.appendChild(me._disclaimer_customized);
		el=me._disclaimer_acabados_en=document.createElement('div');
		els=me._disclaimer_acabados_en__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="Disclaimer acabados_EN";
		el.ggDx=0;
		el.ggDy=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		els.innerHTML="Finishes packcage and project furnishing are referential.";
		el.appendChild(els);
		me._disclaimer_acabados_en.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._disclaimer_acabados_en.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._disclaimer.appendChild(me._disclaimer_acabados_en);
		el=me._disclaimer_acabados_es=document.createElement('div');
		els=me._disclaimer_acabados_es__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="Disclaimer acabados_ES";
		el.ggDx=0;
		el.ggDy=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=false;
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		els.innerHTML="Los acabados y amoblamiento del proyecto son referenciales.";
		el.appendChild(els);
		me._disclaimer_acabados_es.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._disclaimer_acabados_es.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._disclaimer.appendChild(me._disclaimer_acabados_es);
		me.divSkin.appendChild(me._disclaimer);
		el=me._snapping=document.createElement('div');
		el.ggId="Snapping";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_container ";
		...
		me._snapping.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._snapping.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				((player.getViewerSize().width <= 800))
			)
			...
			if (me._snapping.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._snapping.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._snapping.style[domTransition]='' + cssPrefix + 'transform 0s';
				if (me._snapping.ggCurrentLogicStateScaling == 0) {
					me._snapping.ggParameter.sx = 0.7;
					me._snapping.ggParameter.sy = 0.7;
					me._snapping.style[domTransform]=parameterToTransform(me._snapping.ggParameter);
				}
				else {
					me._snapping.ggParameter.sx = 1;
					me._snapping.ggParameter.sy = 1;
					me._snapping.style[domTransform]=parameterToTransform(me._snapping.ggParameter);
				}
			}
		}
		me._snapping.ggUpdatePosition=function (useTransition) {
		}
		el=me._image_1=document.createElement('div');
		els=me._image_1__img=document.createElement('img');
		els.className='ggskin ggskin_image_1';
		hs='data:image/png;base64,'+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			'';
		...
		me._image_1.onclick=function (e) {
			player.openUrl("https:\/\/snapping.com.co\/","");
		}
		me._image_1.ggUpdatePosition=function (useTransition) {
		}
		me._snapping.appendChild(me._image_1);
		el=me._texto_snapping_mobile=document.createElement('div');
		els=me._texto_snapping_mobile__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="Texto Snapping Mobile";
		el.ggDx=-5;
		el.ggDy=-19;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=false;
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		els.innerHTML="Desarrollado por:";
		el.appendChild(els);
		me._texto_snapping_mobile.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._texto_snapping_mobile.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._snapping.appendChild(me._texto_snapping_mobile);
		me.divSkin.appendChild(me._snapping);
		...
		hs='data:image/svg+xml;base64,'+
			''+
		...
		hs='data:image/svg+xml;base64,'+
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		me._tt_fullscreen.logicBlock_text = function() {
			...
			if (me._tt_fullscreen.ggCurrentLogicStateText != newLogicStateText) {
				...
				if (me._tt_fullscreen.ggCurrentLogicStateText == 0) {
					me._tt_fullscreen.ggText="Fullscreen";
					...
					me._tt_fullscreen.ggText="Normalscreen";
					me._tt_fullscreen__text.innerHTML=me._tt_fullscreen.ggText;
					if (me._tt_fullscreen.ggUpdateText) {
					me._tt_fullscreen.ggUpdateText=function() {
						var hs="Normalscreen";
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		me._button_open_map.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((player.getViewerSize().width <= 800))
			)
			...
			if (me._button_open_map.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._button_open_map.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._button_open_map.style[domTransition]='';
				if (me._button_open_map.ggCurrentLogicStateVisible == 0) {
		...
		me._tt_togglemap.logicBlock_text = function() {
			...
			if (me._tt_togglemap.ggCurrentLogicStateText != newLogicStateText) {
				...
				if (me._tt_togglemap.ggCurrentLogicStateText == 0) {
					me._tt_togglemap.ggText="Show Plan";
					...
					me._tt_togglemap.ggText="Hide Plan";
					me._tt_togglemap__text.innerHTML=me._tt_togglemap.ggText;
					if (me._tt_togglemap.ggUpdateText) {
					me._tt_togglemap.ggUpdateText=function() {
						var hs="Hide Plan";
		...
		me._button_close_map.logicBlock_visible = function() {
			...
			if (me._button_close_map.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				else if (me._button_close_map.ggCurrentLogicStateVisible == 1) {
					me._button_close_map.style.visibility="hidden";
					me._button_close_map.ggVisible=false;
				}
				else {
		...
		me._button_close_map.onclick=function (e) {
			player.setVariableValue('vis_map_1', !player.getVariableValue('vis_map_1'));
		}
		...
		el=me._button_close_map_1=document.createElement('div');
		els=me._button_close_map_1__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			'Cg==';
		me._button_close_map_1__img.setAttribute('src',hs);
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els['ondragstart']=function() { return false; };
		el.appendChild(els);
		el.ggSubElement = els;
		el.ggId="button_close_map_1";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_svg ";
		el.ggType='svg';
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._button_close_map_1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._button_close_map_1.ggUpdatePosition=function (useTransition) {
		}
		me._button_close_map.appendChild(me._button_close_map_1);
		me.divSkin.appendChild(me._button_close_map);
		el=me._button_show_thumbnail=document.createElement('div');
		els=me._button_show_thumbnail__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		me._button_show_thumbnail__img.setAttribute('src',hs);
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els['ondragstart']=function() { return false; };
		el.appendChild(els);
		el.ggSubElement = els;
		elo=me._button_show_thumbnail__imgo=document.createElement('img');
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		me._button_show_thumbnail__imgo.setAttribute('src',hs);
		elo.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;;');
		elo['ondragstart']=function() { return false; };
		el.appendChild(elo);
		el.ggId="button_show_thumbnail";
		el.ggDx=65;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_svg ";
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._button_show_thumbnail.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._button_show_thumbnail.onclick=function (e) {
			player.setVariableValue('vis_thumbnail_menu', !player.getVariableValue('vis_thumbnail_menu'));
		}
		me._button_show_thumbnail.onmouseover=function (e) {
			me._button_show_thumbnail__img.style.visibility='hidden';
			me._button_show_thumbnail__imgo.style.visibility='inherit';
			me.elementMouseOver['button_show_thumbnail']=true;
			me._tt_thumbnail_open.logicBlock_visible();
		}
		me._button_show_thumbnail.onmouseout=function (e) {
			me._button_show_thumbnail__img.style.visibility='inherit';
			me._button_show_thumbnail__imgo.style.visibility='hidden';
			me.elementMouseOver['button_show_thumbnail']=false;
			me._tt_thumbnail_open.logicBlock_visible();
		}
		me._button_show_thumbnail.ontouchend=function (e) {
			me.elementMouseOver['button_show_thumbnail']=false;
			me._tt_thumbnail_open.logicBlock_visible();
		}
		me._button_show_thumbnail.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._button_show_thumbnail.appendChild(me._tt_thumbnail_open);
		me.divSkin.appendChild(me._button_show_thumbnail);
		...
		me._thumbnail_menu.ggScrollIntoView = function(posX, posY, width, height) {
			if (me._thumbnail_menu.ggHorScrollVisible) {
				...
				} else if (posX + width > me._thumbnail_menu.offsetWidth - (me._thumbnail_menu.ggVertScrollVisible ? 5 : 0)) {
					var diffX = Math.ceil(((posX + width) - (me._thumbnail_menu.offsetWidth - (me._thumbnail_menu.ggVertScrollVisible ? 5 : 0))) * me._thumbnail_menu.ggHPercentVisible);
					me._thumbnail_menu.ggScrollByXSmooth(diffX);
				}
			}
			if (me._thumbnail_menu.ggVertScrollVisible) {
				...
				} else if (posY + height > me._thumbnail_menu.offsetHeight - (me._thumbnail_menu.ggHorScrollVisible ? 5 : 0)) {
					var diffY = Math.ceil(((posY + height) - (me._thumbnail_menu.offsetHeight - (me._thumbnail_menu.ggHorScrollVisible ? 5 : 0))) * me._thumbnail_menu.ggVPercentVisible);
					me._thumbnail_menu.ggScrollByYSmooth(diffY);
				}
			}
		}
		...
		elHorScrollBg.setAttribute('style', 'position: absolute; left: 0px; bottom: 0px; visibility: hidden; width: 1024px; height: 5px; background-color: rgba(128,128,128,1); pointer-events: auto;');
		elHorScrollBg.className='ggskin ggskin_scrollarea_hscrollbg';
		elHorScrollFg = me._thumbnail_menu__horScrollFg = document.createElement('div');
		elHorScrollBg.appendChild(elHorScrollFg);
		elHorScrollFg.className='ggskin ggskin_scrollarea_hscrollfg';
		elHorScrollFg.setAttribute('style', 'position: absolute; left: 0px; top: 0px; visibility: hidden; width: 1024px; height: 5px; background-color: rgba(244,244,244,1); pointer-events: auto;');
		...
		me._thumbnail_menu.ggUpdatePosition=function (useTransition) {
			...
			}
			{
				...
				if(me._thumbnail_menu.ggHorScrollVisible) {
					me._thumbnail_menu.ggAvailableHeight = me._thumbnail_menu.offsetHeight - 5;
					if (me._thumbnail_menu.ggVertScrollVisible) {
						me._thumbnail_menu.ggAvailableWidth = me._thumbnail_menu.offsetWidth - 5;
		...
		el=me._wellcome_pc=document.createElement('div');
		el.ggId="Wellcome_PC";
		el.ggDx=0;
		el.ggDy=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._wellcome_pc.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._wellcome_pc.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
			...
			if (me._wellcome_pc.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._wellcome_pc.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._wellcome_pc.style[domTransition]='' + cssPrefix + 'transform 0s';
				if (me._wellcome_pc.ggCurrentLogicStateScaling == 0) {
					me._wellcome_pc.ggParameter.sx = 0.8;
					me._wellcome_pc.ggParameter.sy = 0.8;
					me._wellcome_pc.style[domTransform]=parameterToTransform(me._wellcome_pc.ggParameter);
				}
				else {
					me._wellcome_pc.ggParameter.sx = 1;
					me._wellcome_pc.ggParameter.sy = 1;
					me._wellcome_pc.style[domTransform]=parameterToTransform(me._wellcome_pc.ggParameter);
				}
			}
		}
		me._wellcome_pc.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((player.getViewerSize().width <= 800))
			)
			{
				...
				((player.getVariableValue('vis_instructions') == true))
			)
			{
				newLogicStateVisible = 1;
			}
			...
			if (me._wellcome_pc.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._wellcome_pc.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._wellcome_pc.style[domTransition]='' + cssPrefix + 'transform 0s';
				if (me._wellcome_pc.ggCurrentLogicStateVisible == 0) {
					me._wellcome_pc.style.visibility="hidden";
					me._wellcome_pc.ggVisible=false;
				}
				else if (me._wellcome_pc.ggCurrentLogicStateVisible == 1) {
					me._wellcome_pc.style.visibility="hidden";
					me._wellcome_pc.ggVisible=false;
				}
				else {
					me._wellcome_pc.style.visibility=(Number(me._wellcome_pc.style.opacity)>0||!me._wellcome_pc.style.opacity)?'inherit':'hidden';
					me._wellcome_pc.ggVisible=true;
				}
			}
		}
		me._wellcome_pc.onclick=function (e) {
			player.setVariableValue('vis_instructions', !player.getVariableValue('vis_instructions'));
		}
		me._wellcome_pc.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._wellcome_pc.appendChild(me._rectangle_3_1);
		el=me._instructions=document.createElement('div');
		els=me._instructions__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		els.innerHTML="Despl\xe1zate por los diferentes espacios haciendo <br\/>click en los marcadores";
		el.appendChild(els);
		...
		me._wellcome_pc.appendChild(me._instructions);
		...
		me._wellcome_pc.appendChild(me._image_2);
		me.divSkin.appendChild(me._wellcome_pc);
		el=me._welcome_mobile=document.createElement('div');
		el.ggId="Welcome_Mobile";
		el.ggDx=0;
		el.ggDy=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=false;
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._welcome_mobile.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._welcome_mobile.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((player.getVariableValue('vis_instructions') == true))
			)
			...
			if (me._welcome_mobile.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._welcome_mobile.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._welcome_mobile.style[domTransition]='';
				if (me._welcome_mobile.ggCurrentLogicStateVisible == 0) {
					me._welcome_mobile.style.visibility="hidden";
					me._welcome_mobile.ggVisible=false;
				}
				else if (me._welcome_mobile.ggCurrentLogicStateVisible == 1) {
					me._welcome_mobile.style.visibility=(Number(me._welcome_mobile.style.opacity)>0||!me._welcome_mobile.style.opacity)?'inherit':'hidden';
					me._welcome_mobile.ggVisible=true;
				}
				else {
					me._welcome_mobile.style.visibility="hidden";
					me._welcome_mobile.ggVisible=false;
		...
		me._welcome_mobile.onclick=function (e) {
			player.setVariableValue('vis_instructions', !player.getVariableValue('vis_instructions'));
		}
		me._welcome_mobile.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		el=me._instructions_1=document.createElement('div');
		els=me._instructions_1__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="instructions_1";
		el.ggDx=0;
		el.ggDy=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=false;
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		els.innerHTML="Despl\xe1zate por <br\/>los diferentes espacios<br\/>haciendo click en <br\/>los marcadores";
		el.appendChild(els);
		me._instructions_1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._instructions_1.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._welcome_mobile.appendChild(me._instructions_1);
		...
		me._welcome_mobile.appendChild(me._rectangle_3);
		...
		me._welcome_mobile.appendChild(me._image_3);
		me.divSkin.appendChild(me._welcome_mobile);
		el=me._navigation_icons_hidden=document.createElement('div');
		el.ggId="Navigation_icons_hidden";
		el.ggDx=0;
		el.ggDy=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=false;
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._navigation_icons_hidden.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._navigation_icons_hidden.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		el=me._marker_template_id=document.createElement('div');
		el.ggMarkerNodeId='';
		el.ggMarkerInstances = [];
		nodeMarker.push(el);
		el.ggId="marker_template ID";
		el.ggDx=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		...
		me._marker_template_id.ggIsActive=function() {
		...
		me._marker_template_id.onmouseover=function (e) {
			me.elementMouseOver['marker_template_id']=true;
			me._marker_title_txt.logicBlock_visible();
		}
		me._marker_template_id.onmouseout=function (e) {
			me.elementMouseOver['marker_template_id']=false;
			me._marker_title_txt.logicBlock_visible();
		}
		me._marker_template_id.ontouchend=function (e) {
			me.elementMouseOver['marker_template_id']=false;
			me._marker_title_txt.logicBlock_visible();
		}
		me._marker_template_id.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		el=me._marker_title_txt=document.createElement('div');
		els=me._marker_title_txt__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="marker_title_txt";
		el.ggDx=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=false;
		el.className="ggskin ggskin_text ";
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me._marker_title_txt.ggUpdateText=function() {
		...
		me._marker_title_txt.ggUpdateText();
		player.addListener('changenode', function() {
			me._marker_title_txt.ggUpdateText();
		});
		el.appendChild(els);
		me._marker_title_txt.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._marker_title_txt.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				((player.getIsMobile() == true))
			)
			...
			if (me._marker_title_txt.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me._marker_title_txt.ggCurrentLogicStatePosition = newLogicStatePosition;
				me._marker_title_txt.style[domTransition]='left 0s, top 0s';
				if (me._marker_title_txt.ggCurrentLogicStatePosition == 0) {
					this.ggDx = -35;
					me._marker_title_txt.style.top='-25px';
					me._marker_title_txt.ggUpdatePosition(true);
				}
				else {
					me._marker_title_txt.ggDx=0;
					me._marker_title_txt.style.top='20px';
					me._marker_title_txt.ggUpdatePosition(true);
				}
			}
		}
		me._marker_title_txt.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((me.elementMouseOver['marker_title_txt'] == true)) || 
				((me.elementMouseOver['marker_template_id'] == true)) && 
				((me.ggUserdata.title != ""))
			)
			{
			...
			if (me._marker_title_txt.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._marker_title_txt.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._marker_title_txt.style[domTransition]='left 0s, top 0s';
				if (me._marker_title_txt.ggCurrentLogicStateVisible == 0) {
					me._marker_title_txt.style.visibility=(Number(me._marker_title_txt.style.opacity)>0||!me._marker_title_txt.style.opacity)?'inherit':'hidden';
					me._marker_title_txt.ggVisible=true;
				}
				else {
					me._marker_title_txt.style.visibility="hidden";
					me._marker_title_txt.ggVisible=false;
				}
			}
		}
		me._marker_title_txt.onmouseover=function (e) {
			me.elementMouseOver['marker_title_txt']=true;
			me._marker_title_txt.logicBlock_visible();
		}
		me._marker_title_txt.onmouseout=function (e) {
			if (e && e.toElement) {
				var current = e.toElement;
				while (current = current.parentNode) {
				if (current == me._marker_title_txt__text)
					return;
				}
			}
			me.elementMouseOver['marker_title_txt']=false;
			me._marker_title_txt.logicBlock_visible();
		}
		me._marker_title_txt.ontouchend=function (e) {
			me.elementMouseOver['marker_title_txt']=false;
			me._marker_title_txt.logicBlock_visible();
		}
		me._marker_title_txt.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._marker_template_id.appendChild(me._marker_title_txt);
		me._navigation_icons_hidden.appendChild(me._marker_template_id);
		el=me._marker_normal_=document.createElement('div');
		els=me._marker_normal___img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			'';
		me._marker_normal___img.setAttribute('src',hs);
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els['ondragstart']=function() { return false; };
		el.appendChild(els);
		el.ggSubElement = els;
		el.ggId="marker_normal_";
		el.ggDx=0;
		el.ggDy=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._marker_normal_.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._marker_normal_.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._navigation_icons_hidden.appendChild(me._marker_normal_);
		el=me._marker_active_=document.createElement('div');
		els=me._marker_active___img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			'IDxjaXJjbGUgc3Ryb2tlLW1pdGVybGltaXQ9IjEwIiBjeT0iMy45OTQiIHN0cm9rZS1vcGFjaXR5PSIwIiBzdHJva2U9IiNlZTFkM2EiIGZpbGw9IiMwMDAwMDAiIGN4PSIxNC45OCIgZmlsbC1vcGFjaXR5PSIxIiBzdHJva2Utd2lkdGg9IjAuNSIgcj0iMi4xMTciLz4KIDwvZz4KPC9zdmc+Cg==';
		...
		me._navigation_icons_hidden.appendChild(me._marker_active_);
		me.divSkin.appendChild(me._navigation_icons_hidden);
		el=me._navigation=document.createElement('div');
		el.ggId="Navigation";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=false;
		el.className="ggskin ggskin_container ";
		...
		me._navigation.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((player.getViewerSize().width <= 800))
			)
			...
			if (me._navigation.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._navigation.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._navigation.style[domTransition]='';
				if (me._navigation.ggCurrentLogicStateVisible == 0) {
		...
		me._navigation.ggUpdatePosition=function (useTransition) {
		}
		...
		me._map.logicBlock_scaling = function() {
			...
			if (me._map.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				me._map.style[domTransition]='' + cssPrefix + 'transform 0s, opacity 0s';
		...
		me._map.appendChild(me._hall);
		el=me._sala_comedor=document.createElement('div');
		el.ggMarkerNodeId='{node18}';
		el.ggMarkerInstances = [];
		nodeMarker.push(el);
		el.ggId="Sala - Comedor";
		el.ggDx=-31;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_mark ";
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 100%';
		me._sala_comedor.ggIsActive=function() {
			return this.ggIsMarkerActive==true;
		}
		el.ggElementNodeId=function() {
			var hs=String(this.ggMarkerNodeId);
		...
		me._sala_comedor.onclick=function (e) {
			player.openNext('{node18}');
		}
		me._sala_comedor.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._map.appendChild(me._sala_comedor);
		...
		el.ggId="Cocina";
		el.ggDx=5;
		el.ggParameter={ rx:0,ry:0,a:-57,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_mark ";
		el.ggType='mark';
		hs ='';
		...
		me._map.appendChild(me._cocina);
		el=me._terraza=document.createElement('div');
		...
		el.style[domTransform + 'Origin']='50% 100%';
		el.style[domTransform]=parameterToTransform(el.ggParameter);
		me._terraza.ggIsActive=function() {
			return this.ggIsMarkerActive==true;
		}
		el.ggElementNodeId=function() {
			var hs=String(this.ggMarkerNodeId);
		...
		me._terraza.onclick=function (e) {
			player.openNext('{node16}');
		}
		me._terraza.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._map.appendChild(me._terraza);
		el=me._dorm3=document.createElement('div');
		...
		me._dorm3.onclick=function (e) {
			player.openNext('{node17}');
		}
		me._dorm3.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._map.appendChild(me._dorm3);
		el=me._dorm2=document.createElement('div');
		...
		me._dorm2.onclick=function (e) {
			player.openNext('{node19}');
		}
		me._dorm2.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._map.appendChild(me._dorm2);
		el=me._baoaux=document.createElement('div');
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 100%';
		me._baoaux.ggIsActive=function() {
			return this.ggIsMarkerActive==true;
		}
		el.ggElementNodeId=function() {
			var hs=String(this.ggMarkerNodeId);
		...
		me._baoaux.onclick=function (e) {
			player.openNext('{node20}');
		}
		me._baoaux.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._map.appendChild(me._baoaux);
		el=me._dorm_ppal=document.createElement('div');
		el.ggMarkerNodeId='{node21}';
		el.ggMarkerInstances = [];
		nodeMarker.push(el);
		el.ggId="Dorm ppal";
		el.ggDx=31;
		el.ggParameter={ rx:0,ry:0,a:-165,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_mark ";
		el.ggType='mark';
		hs ='';
		...
		el.style[domTransform + 'Origin']='50% 100%';
		el.style[domTransform]=parameterToTransform(el.ggParameter);
		me._dorm_ppal.ggIsActive=function() {
			return this.ggIsMarkerActive==true;
		}
		el.ggElementNodeId=function() {
			var hs=String(this.ggMarkerNodeId);
		...
		me._dorm_ppal.onclick=function (e) {
			player.openNext('{node21}');
		}
		me._dorm_ppal.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._map.appendChild(me._dorm_ppal);
		el=me._baoppal=document.createElement('div');
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 100%';
		me._baoppal.ggIsActive=function() {
			return this.ggIsMarkerActive==true;
		}
		el.ggElementNodeId=function() {
			var hs=String(this.ggMarkerNodeId);
		...
		me._baoppal.onclick=function (e) {
			player.openNext('{node22}');
		}
		me._baoppal.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._map.appendChild(me._baoppal);
		me._navigation.appendChild(me._map);
		me.divSkin.appendChild(me._navigation);
		el=me._project_logo=document.createElement('div');
		els=me._project_logo__img=document.createElement('img');
		els.className='ggskin ggskin_project_logo';
		hs=basePath + 'images/project_logo.png';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els.className='ggskin ggskin_image';
		...
		me._project_logo.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._project_logo.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				((player.getViewerSize().width <= 800))
			)
			...
			if (me._project_logo.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._project_logo.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._project_logo.style[domTransition]='' + cssPrefix + 'transform 0s';
				if (me._project_logo.ggCurrentLogicStateScaling == 0) {
					me._project_logo.ggParameter.sx = 0.7;
					me._project_logo.ggParameter.sy = 0.7;
					me._project_logo.style[domTransform]=parameterToTransform(me._project_logo.ggParameter);
				}
				else {
					me._project_logo.ggParameter.sx = 1;
					me._project_logo.ggParameter.sy = 1;
					me._project_logo.style[domTransform]=parameterToTransform(me._project_logo.ggParameter);
				}
			}
		}
		me._project_logo.ggUpdatePosition=function (useTransition) {
		}
		me.divSkin.appendChild(me._project_logo);
		var clonedNormalElement = new SkinElement_idle_Class(this,me._marker_template_id);
		me._marker_template_id__normal = clonedNormalElement._idle;
		me._marker_template_id__normal.style.visibility='inherit';
		me._marker_template_id__normal.style.left='-11px';
		me._marker_template_id__normal.style.top='-14px';
		me._marker_template_id.ggMarkerNormal=me._marker_template_id__normal;
		me._marker_template_id.ggMarkerInstances.push(me._marker_template_id__normal);
		var clonedActiveElement = new SkinElement_radar_Class(this,me._marker_template_id);
		me._marker_template_id__active= clonedActiveElement._radar;
		me._marker_template_id__active.style.visibility='hidden';
		me._marker_template_id__active.style.left='-40px';
		me._marker_template_id__active.style.top='-80px';
		me._marker_template_id.ggMarkerActive=me._marker_template_id__active;
		me._marker_template_id.ggMarkerInstances.push(me._marker_template_id__active);
		if (me._marker_template_id.firstChild) {
			me._marker_template_id.insertBefore(me._marker_template_id__active,me._marker_template_id.firstChild);
		} else {
			me._marker_template_id.appendChild(me._marker_template_id__active);
		}
		if (me._marker_template_id.firstChild) {
			me._marker_template_id.insertBefore(me._marker_template_id__normal,me._marker_template_id.firstChild);
		} else {
			me._marker_template_id.appendChild(me._marker_template_id__normal);
		}
		for (var i = 0; i < me._marker_template_id.childNodes.length; i++) {
			me._marker_template_id.ggMarkerInstances.push(me._marker_template_id.childNodes[i]);
		}
		me._marker_template_id.callChildLogicBlocks_changenode = function(){
			if(me._marker_template_id.ggMarkerInstances) {
				var i;
				for(i = 0; i < me._marker_template_id.ggMarkerInstances.length; i++) {
					if((me._marker_template_id.ggMarkerInstances[i]) && ((activeNodeMarker.indexOf(me._marker_template_id)>=0 && i==1) || (activeNodeMarker.indexOf(me._marker_template_id)<0 && i==0) || (i>1))) {
					if (me._marker_template_id.ggMarkerInstances[i].logicBlock_visible) {
						me._marker_template_id.ggMarkerInstances[i].logicBlock_visible();
					}
					}
				}
			}
		}
		me._marker_template_id.callChildLogicBlocks_configloaded = function(){
			if(me._marker_template_id.ggMarkerInstances) {
				var i;
				for(i = 0; i < me._marker_template_id.ggMarkerInstances.length; i++) {
					if((me._marker_template_id.ggMarkerInstances[i]) && ((activeNodeMarker.indexOf(me._marker_template_id)>=0 && i==1) || (activeNodeMarker.indexOf(me._marker_template_id)<0 && i==0) || (i>1))) {
					if (me._marker_template_id.ggMarkerInstances[i].logicBlock_position) {
						me._marker_template_id.ggMarkerInstances[i].logicBlock_position();
					}
					}
				}
			}
		}
		me._marker_template_id.callChildLogicBlocks_mouseover = function(){
			if(me._marker_template_id.ggMarkerInstances) {
				var i;
				for(i = 0; i < me._marker_template_id.ggMarkerInstances.length; i++) {
					if((me._marker_template_id.ggMarkerInstances[i]) && ((activeNodeMarker.indexOf(me._marker_template_id)>=0 && i==1) || (activeNodeMarker.indexOf(me._marker_template_id)<0 && i==0) || (i>1))) {
		...
		me._marker_template_id.callChildLogicBlocks_changenode();
		me._marker_template_id.callChildLogicBlocks_configloaded();
		me._marker_template_id.callChildLogicBlocks_mouseover();
		me._marker_template_id.callChildLogicBlocks_mouseover();
		me._hall.ggMarkerNormal=null;
		me._hall.ggMarkerInstances.push(null);
		var clonedActiveElement = new SkinElement_radar_Class(this,me._hall);
		me._hall__active= clonedActiveElement._radar;
		me._hall__active.style.visibility='hidden';
		me._hall__active.style.left='-40px';
		me._hall__active.style.top='-80px';
		me._hall.ggMarkerActive=me._hall__active;
		me._hall.ggMarkerInstances.push(me._hall__active);
		if (me._hall.firstChild) {
			me._hall.insertBefore(me._hall__active,me._hall.firstChild);
		} else {
			me._hall.appendChild(me._hall__active);
		}
		for (var i = 0; i < me._hall.childNodes.length; i++) {
			me._hall.ggMarkerInstances.push(me._hall.childNodes[i]);
		}
		me._sala_comedor.ggMarkerNormal=null;
		me._sala_comedor.ggMarkerInstances.push(null);
		var clonedActiveElement = new SkinElement_radar_Class(this,me._sala_comedor);
		me._sala_comedor__active= clonedActiveElement._radar;
		me._sala_comedor__active.style.visibility='hidden';
		me._sala_comedor__active.style.left='-40px';
		me._sala_comedor__active.style.top='-80px';
		me._sala_comedor.ggMarkerActive=me._sala_comedor__active;
		me._sala_comedor.ggMarkerInstances.push(me._sala_comedor__active);
		if (me._sala_comedor.firstChild) {
			me._sala_comedor.insertBefore(me._sala_comedor__active,me._sala_comedor.firstChild);
		} else {
			me._sala_comedor.appendChild(me._sala_comedor__active);
		}
		for (var i = 0; i < me._sala_comedor.childNodes.length; i++) {
			me._sala_comedor.ggMarkerInstances.push(me._sala_comedor.childNodes[i]);
		}
		me._cocina.ggMarkerNormal=null;
		me._cocina.ggMarkerInstances.push(null);
		var clonedActiveElement = new SkinElement_radar_Class(this,me._cocina);
		me._cocina__active= clonedActiveElement._radar;
		me._cocina__active.style.visibility='hidden';
		me._cocina__active.style.left='-40px';
		me._cocina__active.style.top='-80px';
		me._cocina.ggMarkerActive=me._cocina__active;
		me._cocina.ggMarkerInstances.push(me._cocina__active);
		...
		me._terraza.ggMarkerNormal=null;
		me._terraza.ggMarkerInstances.push(null);
		var clonedActiveElement = new SkinElement_radar_Class(this,me._terraza);
		me._terraza__active= clonedActiveElement._radar;
		me._terraza__active.style.visibility='hidden';
		me._terraza__active.style.left='-40px';
		me._terraza__active.style.top='-80px';
		me._terraza.ggMarkerActive=me._terraza__active;
		me._terraza.ggMarkerInstances.push(me._terraza__active);
		if (me._terraza.firstChild) {
			me._terraza.insertBefore(me._terraza__active,me._terraza.firstChild);
		} else {
			me._terraza.appendChild(me._terraza__active);
		}
		for (var i = 0; i < me._terraza.childNodes.length; i++) {
			me._terraza.ggMarkerInstances.push(me._terraza.childNodes[i]);
		}
		me._dorm3.ggMarkerNormal=null;
		me._dorm3.ggMarkerInstances.push(null);
		var clonedActiveElement = new SkinElement_radar_Class(this,me._dorm3);
		me._dorm3__active= clonedActiveElement._radar;
		me._dorm3__active.style.visibility='hidden';
		me._dorm3__active.style.left='-40px';
		me._dorm3__active.style.top='-80px';
		me._dorm3.ggMarkerActive=me._dorm3__active;
		me._dorm3.ggMarkerInstances.push(me._dorm3__active);
		if (me._dorm3.firstChild) {
			me._dorm3.insertBefore(me._dorm3__active,me._dorm3.firstChild);
		} else {
			me._dorm3.appendChild(me._dorm3__active);
		}
		for (var i = 0; i < me._dorm3.childNodes.length; i++) {
			me._dorm3.ggMarkerInstances.push(me._dorm3.childNodes[i]);
		}
		me._dorm2.ggMarkerNormal=null;
		me._dorm2.ggMarkerInstances.push(null);
		var clonedActiveElement = new SkinElement_radar_Class(this,me._dorm2);
		me._dorm2__active= clonedActiveElement._radar;
		me._dorm2__active.style.visibility='hidden';
		me._dorm2__active.style.left='-40px';
		me._dorm2__active.style.top='-80px';
		me._dorm2.ggMarkerActive=me._dorm2__active;
		me._dorm2.ggMarkerInstances.push(me._dorm2__active);
		if (me._dorm2.firstChild) {
			me._dorm2.insertBefore(me._dorm2__active,me._dorm2.firstChild);
		} else {
			me._dorm2.appendChild(me._dorm2__active);
		}
		for (var i = 0; i < me._dorm2.childNodes.length; i++) {
			me._dorm2.ggMarkerInstances.push(me._dorm2.childNodes[i]);
		}
		me._baoaux.ggMarkerNormal=null;
		me._baoaux.ggMarkerInstances.push(null);
		var clonedActiveElement = new SkinElement_radar_Class(this,me._baoaux);
		me._baoaux__active= clonedActiveElement._radar;
		me._baoaux__active.style.visibility='hidden';
		me._baoaux__active.style.left='-40px';
		me._baoaux__active.style.top='-80px';
		me._baoaux.ggMarkerActive=me._baoaux__active;
		me._baoaux.ggMarkerInstances.push(me._baoaux__active);
		if (me._baoaux.firstChild) {
			me._baoaux.insertBefore(me._baoaux__active,me._baoaux.firstChild);
		} else {
			me._baoaux.appendChild(me._baoaux__active);
		}
		for (var i = 0; i < me._baoaux.childNodes.length; i++) {
			me._baoaux.ggMarkerInstances.push(me._baoaux.childNodes[i]);
		}
		me._dorm_ppal.ggMarkerNormal=null;
		me._dorm_ppal.ggMarkerInstances.push(null);
		var clonedActiveElement = new SkinElement_radar_Class(this,me._dorm_ppal);
		me._dorm_ppal__active= clonedActiveElement._radar;
		me._dorm_ppal__active.style.visibility='hidden';
		me._dorm_ppal__active.style.left='-40px';
		me._dorm_ppal__active.style.top='-80px';
		me._dorm_ppal.ggMarkerActive=me._dorm_ppal__active;
		me._dorm_ppal.ggMarkerInstances.push(me._dorm_ppal__active);
		if (me._dorm_ppal.firstChild) {
			me._dorm_ppal.insertBefore(me._dorm_ppal__active,me._dorm_ppal.firstChild);
		} else {
			me._dorm_ppal.appendChild(me._dorm_ppal__active);
		}
		for (var i = 0; i < me._dorm_ppal.childNodes.length; i++) {
			me._dorm_ppal.ggMarkerInstances.push(me._dorm_ppal.childNodes[i]);
		}
		me._baoppal.ggMarkerNormal=null;
		me._baoppal.ggMarkerInstances.push(null);
		var clonedActiveElement = new SkinElement_radar_Class(this,me._baoppal);
		me._baoppal__active= clonedActiveElement._radar;
		me._baoppal__active.style.visibility='hidden';
		me._baoppal__active.style.left='-40px';
		me._baoppal__active.style.top='-80px';
		me._baoppal.ggMarkerActive=me._baoppal__active;
		me._baoppal.ggMarkerInstances.push(me._baoppal__active);
		if (me._baoppal.firstChild) {
			me._baoppal.insertBefore(me._baoppal__active,me._baoppal.firstChild);
		} else {
			me._baoppal.appendChild(me._baoppal__active);
		}
		for (var i = 0; i < me._baoppal.childNodes.length; i++) {
			me._baoppal.ggMarkerInstances.push(me._baoppal.childNodes[i]);
		}
	...
	me.hotspotProxyOver=function(id, url) {
		if (url=='{}') {
			me._marker_title_txt.onmouseover();
		}
	}
	me.hotspotProxyOut=function(id, url) {
		if (url=='{}') {
			me._marker_title_txt.onmouseout();
		}
	}
	me.callChildLogicBlocksHotspot_hotspots_changenode = function(){
		if(hotspotTemplates['Hotspots']) {
			var i;
			for(i = 0; i < hotspotTemplates['Hotspots'].length; i++) {
				if (hotspotTemplates['Hotspots'][i]._rectangle_1.logicBlock_scaling) {
					hotspotTemplates['Hotspots'][i]._rectangle_1.logicBlock_scaling();
				}
				if (hotspotTemplates['Hotspots'][i]._rectangle_1.logicBlock_alpha) {
					hotspotTemplates['Hotspots'][i]._rectangle_1.logicBlock_alpha();
				}
				if (hotspotTemplates['Hotspots'][i]._rectangle_2.logicBlock_scaling) {
					hotspotTemplates['Hotspots'][i]._rectangle_2.logicBlock_scaling();
				}
				if (hotspotTemplates['Hotspots'][i]._rectangle_2.logicBlock_alpha) {
					hotspotTemplates['Hotspots'][i]._rectangle_2.logicBlock_alpha();
				}
			}
		}
	}
	me.callChildLogicBlocksHotspot_hotspots_configloaded = function(){
		if(hotspotTemplates['Hotspots']) {
			var i;
			for(i = 0; i < hotspotTemplates['Hotspots'].length; i++) {
				if (hotspotTemplates['Hotspots'][i]._tt_hs_name.logicBlock_position) {
					hotspotTemplates['Hotspots'][i]._tt_hs_name.logicBlock_position();
				}
			}
		}
	}
	me.callChildLogicBlocksHotspot_hotspots_mouseover = function(){
		if(hotspotTemplates['Hotspots']) {
			var i;
			for(i = 0; i < hotspotTemplates['Hotspots'].length; i++) {
				if (hotspotTemplates['Hotspots'][i]._tt_hs_name.logicBlock_visible) {
					hotspotTemplates['Hotspots'][i]._tt_hs_name.logicBlock_visible();
				}
			}
		}
	}
	me.callChildLogicBlocksHotspot_hotspots_varchanged_ht_ani = function(){
		if(hotspotTemplates['Hotspots']) {
			var i;
			for(i = 0; i < hotspotTemplates['Hotspots'].length; i++) {
				if (hotspotTemplates['Hotspots'][i]._rectangle_1.logicBlock_scaling) {
	...
	function SkinHotspotClass_hotspots(parentScope,hotspot) {
		var me=this;
		var flag=false;
		var hs='';
		...
		me._hotspots.ondblclick=function (e) {
			skin.hotspotProxyDoubleClick(me.hotspot.id, me.hotspot.url);
		}
		me._hotspots.onmouseover=function (e) {
			player.setActiveHotspot(me.hotspot);
			skin.hotspotProxyOver(me.hotspot.id, me.hotspot.url);
		}
		me._hotspots.onmouseout=function (e) {
		...
		me._ht_image.onmouseover=function (e) {
			...
			me._tt_hs_name.logicBlock_visible();
		}
		...
		el=me._tt_hs_name=document.createElement('div');
		els=me._tt_hs_name__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="tt_hs_name";
		el.ggDx=1;
		...
		el.appendChild(els);
		me._tt_hs_name.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._tt_hs_name.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				((player.getIsMobile() == true))
			)
			...
			if (me._tt_hs_name.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me._tt_hs_name.ggCurrentLogicStatePosition = newLogicStatePosition;
				me._tt_hs_name.style[domTransition]='left 0s, top 0s';
				if (me._tt_hs_name.ggCurrentLogicStatePosition == 0) {
					this.ggDx = 0;
					me._tt_hs_name.style.top='-25px';
					me._tt_hs_name.ggUpdatePosition(true);
				}
				else {
					me._tt_hs_name.ggDx=1;
					me._tt_hs_name.style.top='42px';
					me._tt_hs_name.ggUpdatePosition(true);
				}
			}
		}
		me._tt_hs_name.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((me.elementMouseOver['ht_image'] == true))
			)
			...
			if (me._tt_hs_name.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._tt_hs_name.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._tt_hs_name.style[domTransition]='left 0s, top 0s';
				if (me._tt_hs_name.ggCurrentLogicStateVisible == 0) {
					me._tt_hs_name.style.visibility=(Number(me._tt_hs_name.style.opacity)>0||!me._tt_hs_name.style.opacity)?'inherit':'hidden';
					me._tt_hs_name.ggVisible=true;
				}
				else {
					me._tt_hs_name.style.visibility="hidden";
					me._tt_hs_name.ggVisible=false;
				}
			}
		}
		me._tt_hs_name.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._ht_image.appendChild(me._tt_hs_name);
		me._hotspots.appendChild(me._ht_image);
		me.__div = me._hotspots;
	};
	me.addSkinHotspot=function(hotspot) {
		var hsinst = null;
		{
			hotspot.skinid = 'Hotspots';
			hsinst = new SkinHotspotClass_hotspots(me, hotspot);
			if (!hotspotTemplates.hasOwnProperty(hotspot.skinid)) {
				hotspotTemplates[hotspot.skinid] = [];
			}
			hotspotTemplates[hotspot.skinid].push(hsinst);
			me.callChildLogicBlocksHotspot_hotspots_changenode();;
			me.callChildLogicBlocksHotspot_hotspots_configloaded();;
			me.callChildLogicBlocksHotspot_hotspots_mouseover();;
			me.callChildLogicBlocksHotspot_hotspots_varchanged_ht_ani();;
		}
		return hsinst;
	}
	me.removeSkinHotspots=function() {
		if(hotspotTemplates['Hotspots']) {
			var i;
			for(i = 0; i < hotspotTemplates['Hotspots'].length; i++) {
				hotspotTemplates['Hotspots'][i] = null;
			}
		}
		hotspotTemplates = [];
	}
	function SkinElement_radar_Class(parentScope,ggParent) {
		var me=this;
		var flag=false;
		me.parentScope=parentScope;
		...
		hs='data:image/png;base64,'+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			'GvepE1jdBTL+oWmBkBhFk5mvI2jcPeUTiUqFtgZgQQZhKuaQzOBkFNg7oFlkEAYWYmXHalq5qGtTHt5HVtKCcCCPNyJO+R+y///T/hR/PULTA3AghzMSHzRFJ434e6BRZCAGERbZmahsHMDxZCAGFu4dkgUbfAEgggLCT0Ng3qFljY/wNh/5Yh2ndifAAAAABJRU5ErkJggg==';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els.className='ggskin ggskin_image';
		...
		me._radar.ggUpdateConditionTimer=function() {
			var hs='';
			if (me._radar.ggParameter) {
				hs+=parameterToTransform(me._radar.ggParameter) + ' ';
			}
			hs+='rotate(' + (-1.0*(1 * player.getPanNorth() + 0)) + 'deg) ';
			me._radar.style[domTransform]=hs;
		}
player.addListener('timer', me._radar.ggUpdateConditionTimer);
	};
	function SkinElement_idle_Class(parentScope,ggParent) {
		var me=this;
		var flag=false;
		me.parentScope=parentScope;
		me.ggParent=ggParent;
		...
		el=me._idle=document.createElement('div');
		els=me._idle__img=document.createElement('img');
		els.className='ggskin ggskin_idle';
		hs='data:image/png;base64,'+
			'+rUhhcgaWOeg+AvWahv0oQ6WH7EdC93v+6el7K8PZ0ivPA0Y1dKe1izshaBR3VsRUs/8rFvJglWgPtBQs8ozpTtMFLqsaZdcUbq5sE3hQhYGuC9oIFngDrhmnddkDR1bor2iSnI4ZAAf4Ak5GXJXyDKR4AAAAASUVORK5CYII=';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els.className='ggskin ggskin_image';
		...
		me._idle.ggUpdatePosition=function (useTransition) {
		}
	};
	function SkinCloner_thumbnail_cloner_Class(nodeId, parentScope,ggParent,parameter) {
		...
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
			...
			''+
			...
			''+
			''+
			'MTAuNDAzbC0yLjM5MywyLjM5M1YtMjU4My44Mzd6IiBmaWxsPSJub25lIiBzdHJva2UtbGluZWpvaW49InJvdW5kIiBzdHJva2UtbGluZWNhcD0icm91bmQiIHN0cm9rZS13aWR0aD0iMC4yIi8+CiAgIDwvZz4KICA8L2c+CiA8L2c+Cjwvc3ZnPgo=';
	...
	me._disclaimer.logicBlock_scaling();
	me._snapping.logicBlock_scaling();
	me._button_open_map.logicBlock_visible();
	me._button_close_map.logicBlock_visible();
	me._thumbnail_menu.logicBlock_position();
	me._wellcome_pc.logicBlock_scaling();
	me._wellcome_pc.logicBlock_visible();
	me._welcome_mobile.logicBlock_visible();
	me._navigation.logicBlock_visible();
	me._map.logicBlock_scaling();
	me._project_logo.logicBlock_scaling();
	...
	me._marker_title_txt.logicBlock_position();
	player.addListener('sizechanged', function(args) { me._disclaimer.logicBlock_scaling();me._snapping.logicBlock_scaling();me._button_open_map.logicBlock_visible();me._button_close_map.logicBlock_visible();me._thumbnail_menu.logicBlock_position();me._wellcome_pc.logicBlock_scaling();me._wellcome_pc.logicBlock_visible();me._welcome_mobile.logicBlock_visible();me._navigation.logicBlock_visible();me._map.logicBlock_scaling();me._project_logo.logicBlock_scaling(); });
	...
	player.addListener('changenode', function(args) { me._start_rotate_image.logicBlock_visible();me._tt_rotate_start.logicBlock_text();me._stop_rotate_image.logicBlock_visible();me._tt_togglemap.logicBlock_text();me._button_close_map.logicBlock_visible();me._tt_thumbnail_open.logicBlock_text();me._thumbnail_menu.logicBlock_alpha();me._wellcome_pc.logicBlock_visible();me._welcome_mobile.logicBlock_visible();me._marker_title_txt.logicBlock_visible();me._map.logicBlock_alpha(); });
	player.addListener('configloaded', function(args) { me._tt_zoomout.logicBlock_position();me._tt_zoomin.logicBlock_position();me._tt_rotate_start.logicBlock_position();me._tt_fullscreen.logicBlock_position();me._tt_togglemap.logicBlock_position();me._tt_thumbnail_open.logicBlock_position();me._marker_title_txt.logicBlock_position(); });
	player.addListener('autorotatechanged', function(args) { me._start_rotate_image.logicBlock_visible();me._tt_rotate_start.logicBlock_text();me._stop_rotate_image.logicBlock_visible(); });
	player.addListener('varchanged_vis_map_1', function(args) { me._tt_togglemap.logicBlock_text();me._button_close_map.logicBlock_visible();me._map.logicBlock_alpha(); });
	...
	player.addListener('varchanged_vis_instructions', function(args) { me._wellcome_pc.logicBlock_visible();me._welcome_mobile.logicBlock_visible(); });
	...
	player.addListener('changenode', function(args) { me._marker_template_id.callChildLogicBlocks_changenode(); });
	player.addListener('configloaded', function(args) { me._marker_template_id.callChildLogicBlocks_configloaded(); });
	player.addListener('mouseover', function(args) { me._marker_template_id.callChildLogicBlocks_mouseover(); });
	player.addListener('mouseover', function(args) { me._marker_template_id.callChildLogicBlocks_mouseover(); });
	player.addListener('changenode', function(args) { me.callChildLogicBlocksHotspot_hotspots_changenode(); });
	player.addListener('configloaded', function(args) { me.callChildLogicBlocksHotspot_hotspots_configloaded(); });
	player.addListener('mouseover', function(args) { me.callChildLogicBlocksHotspot_hotspots_mouseover(); });
	player.addListener('varchanged_ht_ani', function(args) { me.callChildLogicBlocksHotspot_hotspots_varchanged_ht_ani(); });
